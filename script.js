// ── PRODUCTS DATA ──────────────────────────────────────────────────────────
// sizes: масив доступних розмірів для кожного товару
const PRODUCTS = [
  {
    id: 1,
    ...
    color: "Чорний",
    colorHex: "#111111",
    desc: "Класичний чорний світшот з фірмовим нашивним патчем.",
    price: 2000,
    tags: ["black", "new"],
    sizes: ["XXL"],
  ...
  },
  {
    ...
    colorHex: "#1a3a8c",
    desc: "Синьо-фіолетовий світшот у морському стилі.",
    price: 2000,
    tags: ["blue", "new"],
    sizes: ["S", "L"],
  ...
  },
  {
    ...
    color: "Бежевий",
    colorHex: "#d8dae0",
    desc: "Бежевий — чистота і мінімалізм.",
    price: 2000,
    tags: ["beige"],
    sizes: ["XL", "XXL"],
  ...
  },
  {
    ...
    color: "Ментол",
    colorHex: "#AAF0D1",
    desc: "Ментоловий світшот у мілітарі стилі.",
    price: 2000,
    tags: ["mentol"],
    sizes: ["M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    color: "Лимонний",
    colorHex: "#F4E300",
    desc: "Лимонний світшот — вишуканість і глибина кольору.",
    price: 2000,
    tags: ["pudra", "new"],
    sizes: ["L"],
  ...
  },
  {
    ...
    color: "Жовтий",
    colorHex: "#e6be00",
    desc: "Жовтий світшот — сонячний настрій весь день.",
    price: 2000,
    tags: ["yellow", "new"],
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    color: "Рожевий",
    colorHex: "#dc508c",
    desc: "Рожевий світшот у трендовому кольорі сезону.",
    price: 2000,
    tags: ["pink"],
    sizes: ["L", "XL", "XXL"],
  ...
  },
  {
    ...
    color: "Зелений",
    colorHex: "#1eb464",
    desc: "Зелений світшот лісової палітри.",
    price: 2000,
    tags: ["green"],
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    color: "Помаранчевий",
    colorHex: "#e66e14",
    desc: "Помаранчеве зіп худі — вогонь і енергія.",
    price: 2500,
    tags: ["orange", "new"],
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    color: "Синій",
    colorHex: "#1E3A8A",
    desc: "Синє зіп худі — глибокий вайб і чистий стиль.",
    price: 2500,
    tags: ["blue", "new"],
    sizes: [],
  ...
  },
  {
    ...
    color: "М'ятний",
    colorHex: "#98FFCC",
    desc: "М'ятне зіп худі — свіжа естетика та легкий вайб.",
    price: 2500,
    tags: ["minty"],
    sizes: ["XL"],
  ...
  },
  {
    ...
    color: "Червоний",
    colorHex: "#C1121F",
    desc: "Червоне зіп худі — яскравий акцент і впевнений стиль.",
    price: 2500,
    tags: ["red"],
    sizes: [],
  ...
  },
  {
    ...
    color: "Білий",
    colorHex: "#FFFFFF",
    desc: "Біле зіп худі — чистий мінімалізм.",
    price: 2500,
    tags: ["white"],
    sizes: ["L", "XL", "XXL"],
  ...
  },
  {
    ...
    color: "Чорний",
    colorHex: "#111111",
    desc: "Чорне зіп худі — класика в сучасному стилі.",
    price: 2500,
    tags: ["black"],
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    color: "Чорний",
    colorHex: "#000000",
    desc: "Чорний зіп світшот — універсальна класика.",
    price: 2200,
    tags: ["black"],
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    color: "Бірюзовий",
    colorHex: "#007C91",
    desc: "Бірюзовий зіп світшот — стильне поєднання свіжого кольору.",
    price: 2200,
    tags: ["turquoise"],
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    color: "Сірий",
    colorHex: "#6B6B6B",
    desc: "Сірий зіп світшот — стриманий стиль і максимальний комфорт.",
    price: 2200,
    tags: ["gray"],
    sizes: ["S", "M", "L", "XL", "XXL"],
  ...
  },
  {
    ...
    color: "Білий",
    colorHex: "#FFFFFF",
    desc: "Білий зіп світшот — чистий мінімалізм для будь-якого образу.",
    price: 2200,
    tags: ["white"],
    sizes: ["S", "XL", "XXL"],
...
async function sendToTelegram(orderData) {
  ...
  const itemLines = items
    .map(
      (i) =>
        `  • ${i.name} (${i.color}), розмір ${i.size} × ${i.qty} — ${(i.price * i.qty).toLocaleString("uk")} грн`,
    )
    .join("\n");
...
function applyTheme(rgb, hex) {
  ...
  const hr = Math.min(255, Math.round(r * 0.08 + 4)),
    hg = Math.min(255, Math.round(g * 0.08 + 4)),
    hb = Math.min(255, Math.round(b * 0.08 + 4));
  root.style.setProperty("--header-bg", `rgba(${hr},${hg},${hb},0.97)`);
  const cr = Math.min(255, Math.round(r * 0.1 + 6)),
    cg = Math.min(255, Math.round(g * 0.1 + 6)),
    cb = Math.min(255, Math.round(b * 0.1 + 6));
  root.style.setProperty("--catalog-bg", `rgb(${cr},${cg},${cb})`);
  const fr = Math.min(255, Math.round(r * 0.13 + 8)),
    fg = Math.min(255, Math.round(g * 0.13 + 8)),
    fb = Math.min(255, Math.round(b * 0.13 + 8));
  ...
  const bgr = Math.min(255, Math.round(r * 0.07 + 4)),
    bgg = Math.min(255, Math.round(g * 0.07 + 4)),
    bgb = Math.min(255, Math.round(b * 0.07 + 4));
...
function setSlide(n) {
  ...
  s.querySelectorAll(".slide-tag,.slide h1,.slide p,.btn-primary").forEach(
    (el, i) => {
  ...
  swatchesContainer
    ...
    .forEach((sw, i) => sw.classList.toggle("active", i === currentSlide));
}
slides.forEach((_, i) => {
...
function renderProducts() {
  ...
  list.forEach((p) => {
    ...
    // Тільки доступні розміри для цього товару
  ...
  grid.querySelectorAll(".size-btn").forEach((btn) => {
    btn.onclick = (e) => {
      ...
      grid
        .querySelectorAll(`.sizes[data-pid="${pid}"] .size-btn`)
        .forEach((s) => {
...
function _lbShow() {
  ...
  // Ховаємо стрілки якщо тільки 1 фото
  const showArrows = lbImages.length > 1;
  document.getElementById("lb-prev").style.display = showArrows
    ? "flex"
    : "none";
  document.getElementById("lb-next").style.display = showArrows
    ? "flex"
    : "none";
}
...
function renderCart() {
  ...
  if (cart.length === 0) {
    el.innerHTML =
      '<div class="cart-empty"><p>Ваш кошик порожній.<br>Оберіть товар у каталозі вище.</p></div>';
    updateSummary(0);
    return;
  }
  el.innerHTML = cart
...
function updateSummary(goods) {
  document.getElementById("sum-count").textContent = cart.reduce(
    (s, i) => s + i.qty,
    0,
  );
  document.getElementById("sum-goods").textContent =
    goods.toLocaleString("uk") + " грн";
  document.getElementById("sum-total").textContent =
    goods.toLocaleString("uk") + " грн";
}
function updateBadge() {
  document.getElementById("cart-badge").textContent = cart.reduce(
    (s, i) => s + i.qty,
    0,
  );
}
...
async function submitOrder() {
  ...
  if (cart.length === 0) {
    showToast("Додайте товари до кошика!");
    return;
  }
  if (!name || !lastname) {
    showToast("Заповніть ім'я та прізвище!");
    return;
  }
  if (!phone) {
    showToast("Заповніть номер телефону!");
    return;
  }
  const total = cart.reduce((s, i) => s + i.product.price * i.qty, 0);
...
function getOrderHistory() {
  try {
    return JSON.parse(localStorage.getItem("si_order_history") || "[]");
  } catch {
    return [];
  }
}
function saveOrderToHistory(order) {
  ...
  history.unshift({ ...order, id: Date.now() });
  if (history.length > 50) history.length = 50;
  localStorage.setItem("si_order_history", JSON.stringify(history));
}
...
function updateHistoryBadge() {
  ...
  if (badge) badge.style.display = history.length > 0 ? "flex" : "none";
}
updateHistoryBadge();
...
function renderHistoryList() {
  ...
  if (history.length === 0) {
    el.innerHTML =
      '<div class="history-empty">Ви ще не зробили жодного замовлення.</div>';
    return;
  }
...
function repeatOrder(id) {
  ...
  order.items.forEach((item) => {
    const product = PRODUCTS.find(
      (p) => p.name === item.name && p.color === item.color,
    );
    if (!product) return;
    for (let i = 0; i < item.qty; i++) addToCart(product.id, item.size);
  });
  closeHistoryModal();
  goTo("order");
  showToast("Замовлення завантажено — перевірте кошик!");
}
function deleteOrder(id) {
  ...
  if (el) {
    ...
    setTimeout(() => renderHistoryList(), 320);
  }
  updateHistoryBadge();
}
...
document.addEventListener("keydown", (e) => {
  ...
  if (
    e.key === "ArrowLeft" &&
    document.getElementById("gallery-lightbox").classList.contains("show")
  )
    lbNavImage(-1);
  if (
    e.key === "ArrowRight" &&
...
// Свайп для лайтбоксу на мобільних
let lbTouchStartX = 0;
document.getElementById("gallery-lightbox").addEventListener(
  "touchstart",
  (e) => {
...
document.getElementById("gallery-lightbox").addEventListener(
  ...
  (e) => {
    ...
    if (Math.abs(dx) > 50) lbNavImage(dx > 0 ? -1 : 1);
  },
  { passive: true },
);
